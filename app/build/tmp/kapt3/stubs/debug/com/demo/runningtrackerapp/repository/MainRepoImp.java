...
public final class MainRepoImp implements com.demo.runningtrackerapp.repository.MainRepo {
    ...
    @java.lang.Override()
    public androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.db.Run>> getAllRunsSortedByDate() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.db.Run>> getAllRunsSortedByDistance() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.db.Run>> getAllRunsSortedByTimeInMillis() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.db.Run>> getAllRunsSortedByAvgSpeed() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.db.Run>> getAllRunsSortedByCaloriesBurned() {
        return null;
    }
