...
public abstract interface MainRepo {
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.model.Run>> getAllRunsSortedByDate();
    
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.model.Run>> getAllRunsSortedByDistance();
    
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.model.Run>> getAllRunsSortedByTimeInMillis();
    
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.model.Run>> getAllRunsSortedByAvgSpeed();
    
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<com.demo.runningtrackerapp.data.model.Run>> getAllRunsSortedByCaloriesBurned();
